...
import { CardTriple } from "../Card/CardTriple";
...
export function Mobile({ scroll }: { scroll: number }) {
  return (
    <section className="bg-white min-h-screen relative">
      ...
      <section className="min-h-screen flex flex-col text-black pt-14">
        ...
        <div className="px-4 mt-2 text-center flex flex-col items-center ">
          <div className="flex items-center text-center justify-center">
            <h1 className="font-bold zilla text-[24px]">Conveniência</h1>
          </div>

          <h1 className="montserrat font-medium text-justify text-[14px] text-gray-600">
            Além de todos os confortos e comodidades dos nossos quartos da linha
            Padrão, no Hotel Van Monet, valorizamos a conveniência e a
            ...
            oferece uma seleção de produtos para garantir uma estadia ainda mais
            confortável e sem preocupações. Conte conosco para tornar sua
            experiência no Hotel Van Monet ainda mais agradável e conveniente,
            24 horas por dia, 7 dias por semana
          </h1>
          <img src="/images/convenienciaIcon.svg" alt="svg" className="w-5" />
        ...
        <div className="h-10 bg-[#186B94] text-white flex items-center justify-center montserrat gap-2 text-xs">
          Criado por
