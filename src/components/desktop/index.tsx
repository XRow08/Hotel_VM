import { Coments } from "../Card/Coments";
import { FloatBar } from "../FloatBar";
import { Float2 } from "../FloatBar/Float2";
import { AlldayIcon } from "../Icons/AlldayIcon";
import { AnimalFriendlyIcon } from "../Icons/AnimalFriendlyIcon";
import { NoCigareteIcon } from "../Icons/NoCigareteIcon";
import { WifiIcon } from "../Icons/WifiIcon";
import { Perguntas } from "../Perguntas";
import { WhatsApp } from "../WhatsApp";

export function Desktop({ scroll }: { scroll: number }) {
  return (
    <section className="bg-white min-h-screen">
      <WhatsApp />
      <div className="bg-gradient-to-b from-[#1E0D45] to-[#1D5E79] min-h-[90vh] w-full drop-shadow-[0px_15px_25px_rgba(0,0,0,.7)] h-[95vh] flex flex-col items-center justify-center px-4">
        <img
          draggable={false}
          alt="logo"
        ...
        <div className="relative mt-10 z-10 w-full flex flex-col items-center justify-center">
          <div className="absolute top-14 text-white text-center w-1/2">
            <h1 className="font-bold zilla text-[52px]">
              Conforto e Conveniência que Você Merece.
            </h1>
            <h1 className="montserrat font-medium text-xl">
          ...
          <img
            ...
            src={"/images/home.png"}
            loading="lazy"
            className="object-cover rounded-2xl h-[525px] w-[80%]"
          />
        </div>

        <FloatBar />
      </div>
      <Float2 scrollPosition={scroll} />
      <section className="min-h-screen flex flex-col text-black w-full">
        <div className="text-start flex flex-col items-center px-[5%] mt-40 justify-between w-full">
          <div className="flex flex-col items-center justify-center mb-10">
            <h1 className="font-bold zilla text-[30px]">
              Apartamento Amplo com 16m2
            </h1>
            <h1 className="montserrat font-medium text-gray-600 text-center w-3/5">
              ...
              Com uma área generosa, cada quarto oferece espaço suficiente para
              os hóspedes se movimentarem livremente e desfrutarem de um
          ...
          <div className="flex flex-wrap items-center justify-center gap-10">
            <img
              draggable={false}
              src="/images/quarto3D.png"
              alt="quarto"
              className="rounded-2xl object-cover h-[15em] w-[18em] border-2 border-[#186B94]"
            />
            <img
              draggable={false}
              src="/images/quarto.png"
              alt="quarto"
              className="rounded-2xl object-cover h-[15em] w-[18em] border-2 border-[#186B94]"
            />
            <img
              draggable={false}
              src="/images/quarto2.jpeg"
              alt="quarto"
              className="rounded-2xl object-cover h-[15em] w-[18em] border-2 border-[#186B94]"
            />
            <img
              draggable={false}
              src="/images/quarto3.jpeg"
              alt="quarto"
              className="rounded-2xl object-cover h-[15em] w-[18em] border-2 border-[#186B94]"
            />
            <img
              draggable={false}
              src="/images/quarto4.jpeg"
              alt="quarto"
              className="rounded-2xl object-cover h-[15em] w-[18em] border-2 border-[#186B94]"
            />
          </div>
        ...
        <div className="flex items-center justify-center gap-6 lg:gap-4 mt-8 lg:mt-20">
          <AlldayIcon />
          <AnimalFriendlyIcon />
          <WifiIcon />
          <NoCigareteIcon />
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col justify-center items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              <h1 className="font-bold zilla text-[30px] text-center">
                Banheiro Privativo
              </h1>
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Cada quarto da linha Padrão está equipado com um banheiro
                privativo, garantindo privacidade e conveniência. O chuveiro
                elétrico proporciona uma experiência de banho confortável e
                relaxante, com temperatura controlável para se adequar às suas
                preferências. Além disso, o banheiro é abastecido com toalhas
                higienizadas e amenidades essenciais, como sachês de shampoo e
                sabonete, mantendo tudo que você precisa ao alcance para um
                começo de dia revigorante ou um relaxante fim de noite
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10">
              <img
                draggable={false}
                src="/images/banheiro.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                draggable={false}
                src="/images/banheiro.png"
          ...
          <div className="flex flex-col items-center mt-20 w-full">
            <svg width="32" height="32" viewBox="0 0 17 19" fill="none">
              <path
            ...
            <div className="w-1/2 h-[1px] my-6 bg-[#989898]" />
          </div>
        </div>
          ...
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                ...
                tipo box com colchões de mola ensacada. Esses colchões
                proporcionam suporte individualizado, ajustando-se ao contorno
                do corpo para um sono tranquilo e restaurador. As molas
                ensacadas reduzem a transferência de movimento, tornando-as
                ideais para casais, e promovem uma ventilação adequada, mantendo
                o colchão fresco e confortável durante a noite
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
                draggable={false}
                src="/images/camas.jpg"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                draggable={false}
                src="/images/colchao_mola.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
            </div>
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Priorizamos o conforto e a durabilidade nas roupas de cama da
                linha Padrão do Hotel Van Monet. Utilizamos lençóis e fronhas de
                200 fios, que oferecem um equilíbrio ideal entre resistência e
                maciez. Esta contagem de fios é escolhida para garantir uma
                textura confortável ao toque, ao mesmo tempo que proporciona uma
                ventilação adequada durante o sono
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
              ...
              <img
                draggable={false}
                src="/images/fios_misto.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                draggable={false}
                src="/images/coberta.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
            </div>
          ...
          <div className="flex flex-col items-center mt-20 w-full">
            <svg width="32" height="32" viewBox="0 0 17 17" fill="none">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                ...
                controle preciso da temperatura, permitindo aos hóspedes ajustar
                o clima de seus quartos para atender às suas preferências
                pessoais, garantindo conforto em todas as estações
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
                draggable={false}
                src="/images/arcondicionado2.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
          ...
          <div className="flex flex-col items-center mt-20 w-full">
            <svg width="52" height="32" viewBox="0 0 31 17" fill="none">
              <path
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Em cada quarto da linha Padrão do Hotel Van Monet,
                disponibilizamos uma Smart TV de 32 polegadas com alta definição
                e uma ampla seleção de canais a cabo. Os hóspedes podem
                desfrutar de uma variedade de programas, notícias, esportes e
                entretenimento, ou acessar suas próprias contas de serviços de
                streaming para um entretenimento personalizado. Esta comodidade
                assegura tanto relaxamento quanto informação, tudo ao alcance de
                um controle remoto
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
          ...
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                ...
                frigobar de 45 litros, oferecendo conveniência e privacidade.
                Ideal para manter suas bebidas e snacks resfriados, o frigobar é
                uma comodidade perfeita para hóspedes que preferem a facilidade
                de ter opções de consumo ao seu alcance, sem precisar sair do
                quarto. Nota: o frigobar é fornecido vazio, permitindo aos
                hóspedes personalizar seu conteúdo com itens adquiridos no nosso
                PDV de conveniência ou fora do hotel
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
                draggable={false}
                src="/images/frigobar.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                draggable={false}
                src="/images/frigobar2.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
            </div>
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Aproveite a conveniência de uma mesa de trabalho espaçosa em
                cada quarto da linha Padrão. Projetada para proporcionar
                conforto e praticidade, esta mesa é ideal para hóspedes que
                precisam manter a produtividade durante a estadia. Com espaço
                suficiente para acomodar seu laptop e documentos, a mesa também
                oferece uma posição ergonômica que ajuda a manter o foco, seja
                para negócios ou planejamento pessoal
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Mantenha-se conectado sem esforço com a nossa conexão Wi-Fi de
                alta velocidade disponível em todos os quartos da linha Padrão.
                Ideal para hóspedes que precisam de acesso constante à internet,
                seja para trabalho, entretenimento ou planejamento de
                atividades, nosso Wi-Fi confiável garante que você possa
                navegar, streamar e comunicar-se com eficiência e conforto. Com
                cobertura completa em cada quarto, você pode contar com uma
                conexão estável para atender todas as suas necessidades digitais
                durante a estadia
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Comece o dia com energia e sabor com nosso café da manhã
                incluso, servido diariamente no salão do refeitório. Nosso
                buffet abrangente apresenta uma seleção diversificada de itens
                frescos e nutritivos que atendem a todos os gostos. Desfrute de
                uma variedade de pães, frutas frescas, frios, cereais, bebidas
                quentes e frias, além de pratos quentes como ovos mexidos e
                salsicha ao molho. Preparado com ingredientes de qualidade,
                nosso café da manhã é a maneira perfeita de preparar-se para um
                dia de atividades ou relaxamento
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
                draggable={false}
                src="/images/cafe_manha.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                draggable={false}
                src="/images/cafe_manha2.png"
                alt="banheiro"
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
            </div>
        ...
        <div className="text-start flex flex-col items-center px-[10%] mt-20 w-full">
          <div className="flex flex-col items-center gap-[5%]">
            <div className="w-full mb-10 flex flex-col justify-center items-center">
              ...
              <h1 className="montserrat font-medium text-gray-600 text-center w-3/4">
                Além de todos os confortos e comodidades dos nossos quartos da
                linha Padrão, no Hotel Van Monet, valorizamos a conveniência e a
                praticidade para nossos hóspedes. É por isso que oferecemos uma
                Conveniência na recepção 24 horas. Com acesso fácil e
                disponibilidade constante, nossa conveniência está sempre pronta
                para atender às suas necessidades a qualquer hora do dia ou da
                noite. Seja para uma bebida refrescante, um lanche rápido ou
                qualquer outra necessidade de última hora, nossa conveniência
                oferece uma seleção de produtos para garantir uma estadia ainda
                mais confortável e sem preocupações. Conte conosco para tornar
                sua experiência no Hotel Van Monet ainda mais agradável e
                conveniente, 24 horas por dia, 7 dias por semana
              </h1>
            </div>
            <div className="flex items-center justify-center gap-10 w-full h-full">
              <img
                src="/images/conveniencia.jpeg"
                alt="banheiro"
                draggable={false}
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
              <img
                src="/images/conveniencia2.jpeg"
                alt="banheiro"
                draggable={false}
                className="rounded-2xl object-cover w-[24em] h-[20em] border-2 border-[#186B94]"
              />
          ...
          <div className="flex flex-col items-center mt-20 w-full">
            <img
              draggable={false}
              src="/images/convenienciaIcon.svg"
              alt="images"
              className="w-10"
            />
        ...
        <div className="min-h-[70vh] bg-gradient-to-t text-center from-[#1E0D45] text-gray-100 to-[#1D5E79] drop-shadow-[0px_15px_25px_rgba(0,0,0,.7)] py-6 flex flex-col items-center justify-center ">
          <div className="px-10">
            ...
            <h1 className="montserrat font-medium text-justify text-[24px] text-gray-200 mb-10">
        ...
        <div className="flex flex-col items-center text-center justify-center p-4 my-20">
          <h1 className="font-bold zilla text-[52px] mb-4">
            Nossa localização
          </h1>
          <iframe
        ...
        <div className="h-20 bg-[#186B94] text-white flex items-center justify-center montserrat gap-2 text-xs">
          Criado por
          <a target="_blank" href="https://xrtech.netlify.app">
            <img
              alt="logo"
